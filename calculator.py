...
boton_parentesis_izq = Button(ventana, text = "(", width = 5, height = 2, command = lambda: click_boton("("))
boton_parentesis_der = Button(ventana, text = ")", width = 5, height = 2, command = lambda: click_boton(")"))
...
boton_igual = Button(ventana, text = "=", width = 5, height = 2, command = lambda: operation())
